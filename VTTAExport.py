			...
			for col, field in enumerate(VTTAFields):
				{
					...
					'Rider StateProv':	lambda : sheetFit.write( row, col,
																...
																leftAlignStyle ),
					'Rider NatCode':	lambda : sheetFit.write( row, col, getattr(rr, 'NatCode', ''), leftAlignStyle ),
					...
					'Rider UCIID':		lambda : sheetFit.write( row, col, getattr(rr, 'UCIID', ''), leftAlignStyle ),

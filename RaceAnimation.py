...
class RaceAnimation( wx.Panel ):
	def __init__( self, parent, id = wx.ID_ANY ):
		...
		self.updateWatch = wx.Button( self, label = _('Update') )
	...
	def doChooseCategory( self, event ):
		Model.setCategoryChoice( self.categoryChoice.GetSelection(), 'raceAnimationCategory' )
		self.refresh()

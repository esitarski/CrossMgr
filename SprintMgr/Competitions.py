...
def getCompetitions():
	...
	competitions.append(
		Competition( 'MTB: XCE 36', [
			Tournament( '', [
				System( 'Round 1', [
					Event( 'N1 N12 N13 N24 N25 N36 -> 1A 2A  1RR_1_3  2RR_1_4  3RR_1_5  4RR_1_6' ),
					Event( 'N6  N7 N18 N19 N30 N31 -> 3A 4A  5RR_1_3  6RR_1_4  7RR_1_5  8RR_1_6' ),
					Event( 'N3 N10 N15 N22 N27 N34 -> 5A 6A  9RR_1_3 10RR_1_4 11RR_1_5 12RR_1_6' ),
					Event( 'N4  N9 N16 N21 N28 N33 -> 1B 2B 13RR_1_3 14RR_1_4 15RR_1_5 16RR_1_6' ),
					Event( 'N2 N11 N14 N23 N26 N35 -> 3B 4B 17RR_1_3 18RR_1_4 19RR_1_5 20RR_1_6' ),
					Event( 'N5  N8 N17 N20 N29 N32 -> 5B 6B 21RR_1_3 22RR_1_4 23RR_1_5 24RR_1_6' ),
				]),
				System( '1/2 Finals', [
	...
	competitions.append(
		Competition( 'MTB: XCE 32', [
			Tournament( '', [
				System( '1/8 Finals', [
					Event( 'N1 N16 N17 N32 -> 1A1 1A2  1RR_1_3  2RR_1_4' ),
					Event( 'N8  N9 N24 N25 -> 2A3 2A4  3RR_1_3  4RR_1_4' ),
					Event( 'N5 N12 N21 N28 -> 3B1 3B2  5RR_1_3  6RR_1_4' ),
					Event( 'N4 N13 N20 N29 -> 4B3 4B4  7RR_1_3  8RR_1_4' ),
					Event( 'N2 N15 N18 N31 -> 5C1 5C2  9RR_1_3 10RR_1_4' ),
					Event( 'N7 N10 N23 N26 -> 6C3 6C4 11RR_1_3 12RR_1_4' ),
					Event( 'N3 N14 N19 N30 -> 7D1 7D2 13RR_1_3 14RR_1_4' ),
					Event( 'N6 N11 N22 N27 -> 8D3 8D4 15RR_1_3 16RR_1_4' ),
				]),
				System( '1/4 Finals', [
					Event( '1A1 1A2 2A3 2A4 -> 1E1 1E2 1RR_2_3 2RR_2_4' ),
					Event( '3B1 3B2 4B3 4B4 -> 2E3 2E4 3RR_2_3 4RR_2_4' ),
					Event( '5C1 5C2 6C3 6C4 -> 3F1 3F2 5RR_2_3 6RR_2_4' ),
					Event( '7D1 7D2 8D3 8D4 -> 3F3 3F4 7RR_2_3 8RR_2_4' ),
				]),
				System( '1/2 Finals', [
	...
	competitions.append(
		Competition( 'MTB: XCE 16', [
			Tournament( '', [
				System( '1/4 Finals', [
					Event( 'N1 N8  N9 N16 -> 1E1 1E2 1RR_1_3 2RR_1_4' ),
					Event( 'N4 N5 N12 N13 -> 2E3 2E4 3RR_1_3 4RR_1_4' ),
					Event( 'N2 N7 N10 N15 -> 3F1 3F2 5RR_1_3 6RR_1_4' ),
					Event( 'N3 N6 N11 N14 -> 3F3 3F4 7RR_1_3 8RR_1_4' ),
				]),
				System( '1/2 Finals', [
					Event( '1E1 1E2 2E3 2E4 -> 1G1 1G2 1G3 1G4' ),
					Event( '3F1 3F2 3F3 3F4 -> 2H1 2H2 2H3 2H4' ),
	...
	competitions.append(
		Competition( 'MTB: Four Cross 64', [
			Tournament( '', [
				System( 'Round 1', [
					Event( 'N64  N1 N33 N32 -> 32A  1A  1RR_1_3  2RR_1_4' ),
					Event( 'N17 N49 N16 N48 -> 17A 16A  3RR_1_3  4RR_1_4' ),
					Event( 'N40 N25 N57  N8 -> 25A  8A  5RR_1_3  6RR_1_4' ),
					Event( 'N41 N24 N56  N9 -> 24A  9A  7RR_1_3  8RR_1_4' ),
					Event( 'N29  N4 N36 N61 -> 29A  4A  9RR_1_3 10RR_1_4' ),
					Event( 'N45 N20 N13 N52 -> 20A 13A 11RR_1_3 12RR_1_4' ),
					Event( 'N28 N37  N5 N60 -> 28A  5A 13RR_1_3 14RR_1_4' ),
					Event( 'N44 N21 N12 N53 -> 21A 12A 15RR_1_3 16RR_1_4' ),
					Event( 'N34 N31 N63  N2 -> 31A  2A 17RR_1_3 18RR_1_4' ),
					Event( 'N47 N18 N50 N15 -> 18A 15A 19RR_1_3 20RR_1_4' ),
					Event( 'N39 N26  N7 N58 -> 26A  7A 21RR_1_3 22RR_1_4' ),
					Event( 'N10 N55 N23 N42 -> 23A 10A 23RR_1_3 24RR_1_4' ),
					Event( 'N30 N35 N62  N3 -> 30A  3A 25RR_1_3 26RR_1_4' ),
					Event( 'N19 N46 N51 N14 -> 19A 14A 27RR_1_3 28RR_1_4' ),
					Event( 'N38 N27  N6 N59 -> 27A  6A 29RR_1_3 30RR_1_4' ),
					Event( 'N43 N22 N11 N54 -> 22A 11A 31RR_1_3 32RR_1_4' ),
				]),
				System( 'Round 2', [
					Event( '32A 1A 17A 16A -> 1B 16B  1RR_2_3  2RR_2_4' ),
					Event( '25A 8A 24A  9A -> 8B  9B  3RR_2_3  4RR_2_4' ),
					Event( '29A 4A 20A 13A -> 4B 13B  5RR_2_3  6RR_2_4' ),
					Event( '28A 5A 21A 12A -> 5B 12B  7RR_2_3  8RR_2_4' ),
					Event( '31A 2A 18A 15A -> 2B 15B  9RR_2_3 10RR_2_4' ),
					Event( '26A 7A 23A 10A -> 7B 10B 11RR_2_3 12RR_2_4' ),
					Event( '30A 3A 19A 14A -> 3B 14B 13RR_2_3 14RR_2_4' ),
					Event( '27A 6A 22A 11A -> 6B 11B 15RR_2_3 16RR_2_4' ),
				]),
				System( 'Round 3', [
					Event( '1B 16B 8B  9B -> 1C 8C 1RR_3_3 2RR_3_4' ),
					Event( '4B 13B 5B 12B -> 4C 5C 3RR_3_3 4RR_3_4' ),
					Event( '2B 15B 7B 10B -> 2C 7C 5RR_3_3 6RR_3_4' ),
					Event( '3B 14B 6B 11B -> 3C 6C 7RR_3_3 8RR_3_4' ),
				]),
				System( 'Round 4', [
